...
class Settings(BaseSettings):
    ...
    STEAM_AUTO_SYNC_INTERVAL_SECONDS: int = 1800
    STEAM_AUTO_SYNC_POLL_SECONDS: int = 300
    STEAM_AUTO_SYNC_BATCH_SIZE: int = 20
    STEAM_AUTO_SYNC_STARTUP_DELAY_SECONDS: int = 10
